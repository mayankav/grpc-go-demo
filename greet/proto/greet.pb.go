...
func (x *GreetResposne) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetResposne) ProtoMessage() {}

func (x *GreetResposne) ProtoReflect() protoreflect.Message {
	mi := &file_greet_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetResposne.ProtoReflect.Descriptor instead.
func (*GreetResposne) Descriptor() ([]byte, []int) {
	return file_greet_proto_rawDescGZIP(), []int{1}
}

func (x *GreetResposne) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x6e, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01,
	...
	0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x73, 0x6e,
	...
	0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x73, 0x6e, 0x65, 0x30, 0x01,
	0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d,
	0x61, 0x79, 0x61, 0x6e, 0x6b, 0x61, 0x76, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x67, 0x6f, 0x2d,
	0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_greet_proto_goTypes = []interface{}{
	...
	(*GreetResposne)(nil), // 1: greet.GreetResposne
}
var file_greet_proto_depIdxs = []int32{
	...
	1, // 2: greet.GreetService.Greet:output_type -> greet.GreetResposne
	1, // 3: greet.GreetService.GreetManyTimes:output_type -> greet.GreetResposne
