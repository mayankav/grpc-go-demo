...
type GreetServiceClient interface {
	Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResposne, error)
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResposne, error) {
	out := new(GreetResposne)
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreetResposne, error) {
	m := new(GreetResposne)
...
type GreetServiceServer interface {
	Greet(context.Context, *GreetRequest) (*GreetResposne, error)
	// returns a stream of GreetResponse
...
func (UnimplementedGreetServiceServer) Greet(context.Context, *GreetRequest) (*GreetResposne, error) {
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreetResposne) error {
